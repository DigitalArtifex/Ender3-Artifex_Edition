...
#define STRING_CONFIG_H_AUTHOR "(g0ldenerd, SKR-mini-E3-V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 Artifex Edition"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "b2e9cd1e-e48a-4c3d-b250-2eed8991baca"
...
#define Z_PROBE_LOW_POINT          -20 // (mm) Farthest distance below the trigger-point to go before stopping
