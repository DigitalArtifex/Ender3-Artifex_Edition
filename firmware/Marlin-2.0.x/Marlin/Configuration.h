...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, SKR-mini-E3-V3.0, g0ldenerd)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Artifex"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 398, 93 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 100, 32 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 300, 100, 32 } // ...or, set your own edit limits
#endif
...
#define XY_PROBE_FEEDRATE (2048)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (256)
...
// Lead Screw driven, don't invert
